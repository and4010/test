...
class DeFish1280Ceiling {
   ...
   // var undistPixel =IntArray(1947*620,{i->0})
    ...
    public fun deFish1280( bitmap:Bitmap):Bitmap{
...
//        val blue = Color.blue(colour)
        ...
        Log.e("123"," defish cretae time=${(System.currentTimeMillis()-t0)}  " )
        if(matrix==null){
...
//                val colour = bitmap.getPixel(xS.toInt(), yS.toInt())
                    ...
                    matrix!![xr][yr]=xS.toInt()
                    matrixY!![xr][yr]=yS.toInt()
    ...
    public fun deFish12801R( bitmap:Bitmap,dx:Int,dy:Int):Bitmap?{
        if(matrix==null){
            Log.e("123"," defish 1280 matrix not init " )
            return null;
        }
...
//        val blue = Color.blue(colour)
        ...
        var yS = 0.0
        var y = dy
        val result = Bitmap.createBitmap(DeFish1280.width1R1280, DeFish1280.width1R1280,Bitmap.Config.RGB_565)
        val outPixels = IntArray(DeFish1280.width1R1280 * DeFish1280.width1R1280)
        Log.e("123"," defish cretae time=${(System.currentTimeMillis()-t0)}  " )

        while( y <= dy+DeFish1280.width1R1280) {
            var x = dx
            while (x <=dx+DeFish1280.width1R1280 ){

                    val  xx= matrix!![x][y]
                    val  yy= matrixY!![x][y]
                    val colour = pixels[(yy.toInt()*BitmapWidth+xx.toInt())]
                    var outIndex=(y-dy)*DeFish1280.width1R1280+(x-dx)
                    if (outIndex<outPixels.size) outPixels[(y-dy)*DeFish1280.width1R1280+(x-dx)]=colour
        ...
        result.setPixels(outPixels, 0, DeFish1280.width1R1280, 0, 0,DeFish1280.width1R1280, DeFish1280.width1R1280)
        // Log.e("123","i="+i)
