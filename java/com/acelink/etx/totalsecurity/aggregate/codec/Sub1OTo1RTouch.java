...
class Sub1OTo1RTouch implements View.OnTouchListener {

    private Sub1OTo1RTouch(){}
    ...
    private float initScale=3.3f;

    public Sub1OTo1RTouch(ImageView mView, int bitmapWIDTH, int bitmapHEIGHT){
    ...
    {
        initTransValue();
        updateMatrix(initScale,transX,transY);
    }
    /**
     * 0x0000, init
     */
    ...
    public boolean onTouch(View v, MotionEvent event) {
      ...
      /*  if (!isMove &&  (mode == (MODE_UP + MODE_DOWN))) {
         ...
         Log.e("123","isMove="+isMove+",mscale="+mscale+",normal_scale_portrait="+normal_scale_portrait+",move="+move+",premove"+premove+",mode="+mode+",isDrag="+isDrag);
        if ((isMove && premove == move) && mode == MODE_DOWN && mode != (MODE_UP + MODE_DOWN) )
        {
            ...
            }  else
            {
                ...
                Log.e("123", "Sub1OTo1RTouch surfaceWIDTH=" + surfaceWIDTH + ",surfaceImageWIDTH=" + surfaceImageWIDTH + ",mscale=" + mscale + ",transX=" + transY + ",delta=" + (mscale*surfaceImageWIDTH-surfaceWIDTH));
               // Log.e("123", "Sub1OTo1RTouch ViewHeight=" + surfaceHEIGHT + ",surfaceImageHEIGHT=" + surfaceImageHEIGHT + ",mscale=" + mscale + ",transY=" + transY + ",delta=" + (mscale*surfaceImageHEIGHT-surfaceHEIGHT));
    ...
    private void initTransValue()
    {
        ...
        transX= (int) (bitmapWIDTH*0.08f*initScale);
        transY=(int) -(bitmapHEIGHT*0.1f*initScale);
    ...
    private void updateMatrix(float scale,int Tx,int Ty)
    {
        ...
        float scaleX;//normalize scale
        float scaleY;//normalize scale
        ...
        Log.e("Sub1OTo1PTouch", "updateMatrix scale="+scale+ ",width=" + (width)+ ",height=" + (height)+ ",scaledWidth=" +scaledWidth+" scaledHeight=" + scaledHeight + ",scaleX=" + scaleX+",Tx="+Tx );
